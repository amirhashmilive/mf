# bulk-create-pages.ps1
# Creates all remaining directory-based pages for the Meer Foundation website restructure

$base = "d:\DRIVE (Ai) Agents\00 Projects\Meer Foundation Website"

# Helper: get correct relative path to assets (depth = how many levels deep the page is)
function Get-AssetPath($depth) {
    return ("../" * $depth)
}

# Helper: write a page file
function Write-Page($relativePath, $title, $metaDesc, $canonical, $depth, $h1, $sectionTag, $bodyContent) {
    $assetPath = Get-AssetPath $depth
    $compScript = "${assetPath}assets/js/components-sub.js?v=4"
    $coreScript = "${assetPath}assets/js/core.js?v=4"
    $css = "${assetPath}assets/css/style.css?v=4"
...
Write-Page "initiatives\index.html" `
  "Initiatives | Meer Foundation" `
  "Discover Meer Foundation's initiatives across education, health, environment, and livelihood in Chhattisgarh." `
  "initiatives/" 2 `
...
Write-Page "initiatives\education\index.html" `
  "Education Initiative — Prayaas | Meer Foundation" `
  "Meer Foundation's Prayaas initiative delivers quality education to rural Chhattisgarh through smart classrooms, scholarships, and teacher training in 150+ schools." `
  "initiatives/education/" 3 `
  "Education" "SDG 4" `
  @"
<section class="section" style="padding-top:140px;background:var(--bg-2);">
  <div class="container">
...
Write-Page "initiatives\health\index.html" `
  "Health & Well-being — Yoga Kutumb | Meer Foundation" `
  "Meer Foundation's Yoga Kutumb initiative promotes holistic well-being through certified yoga training and community wellness programmes in rural Chhattisgarh." `
  "initiatives/health/" 3 `
...
Write-Page "initiatives\environment\index.html" `
  "Environment — Bolti Nadi River Conservation | Meer Foundation" `
  "Bolti Nadi: Meer Foundation's flagship river conservation initiative documenting and protecting Chhattisgarh's rivers through community-led walks and scientific assessment." `
  "initiatives/environment/" 3 `
  "Environment &amp; Conservation" "SDG 6 · SDG 15" `
  @"
<section class="section" style="padding-top:140px;background:var(--bg-2);">
  <div class="container">
    <div class="section-header reveal">
...
Write-Page "initiatives\livelihood\index.html" `
  "Livelihood — Farmours Initiative | Meer Foundation" `
  "Farmours — Meer Foundation's indigenous farming systems initiative empowering rural women entrepreneurs with sustainable livelihood in Chhattisgarh." `
  "initiatives/livelihood/" 3 `
  "Livelihood &amp; Entrepreneurship" "SDG 1 · SDG 2 · SDG 8" `
  @"
<section class="section" style="padding-top:140px;background:var(--bg-2);">
  <div class="container">
    <div class="section-header reveal">
...
# ── INITIATIVE DETAIL PAGES (mirroring existing flat files) ──────────────────

Write-Page "initiatives\bolti-nadi\index.html" `
  "Bolti Nadi | Flagship River Conservation Initiative — Meer Foundation" `
  "Bolti Nadi: Meer Foundation's 90km Sakri River Walk documenting and protecting Chhattisgarh's rivers through community-led conservation since 2016." `
  "initiatives/bolti-nadi/" 3 `
  "Bolti Nadi" "Flagship Initiative" `
  @"
...
Write-Page "initiatives\farmours\index.html" `
  "Farmours — Indigenous Farming & Livelihood | Meer Foundation" `
  "Farmours: Meer Foundation's indigenous farming systems initiative supporting 216+ women entrepreneurs through sustainable livelihood in Chhattisgarh." `
  "initiatives/farmours/" 3 `
  "Farmours Initiative" "SDG 1 · SDG 2 · SDG 8" `
  @"
<section class="section" style="padding-top:140px;background:var(--bg-2);">
  <div class="container">
    <div class="section-header reveal">
...
Write-Page "initiatives\prayaas\index.html" `
  "Prayaas — Quality Education Initiative | Meer Foundation" `
  "Prayaas: Meer Foundation's flagship education initiative delivering smart classrooms, scholarships, and digital learning to 150+ schools in rural Chhattisgarh." `
  "initiatives/prayaas/" 3 `
  "Prayaas: Reshaping Rural Education" "SDG 4" `
  @"
<section class="section" style="padding-top:140px;background:var(--bg-2);">
...
Write-Page "initiatives\yoga-kutumb\index.html" `
  "Yoga Kutumb — Health & Well-being Initiative | Meer Foundation" `
  "Yoga Kutumb: Meer Foundation's holistic wellness programme training community yoga instructors and promoting well-being in rural Chhattisgarh." `
  "initiatives/yoga-kutumb/" 3 `
  "Yoga Kutumb" "SDG 3" `
  @"
<section class="section" style="padding-top:140px;background:var(--bg-2);">
...
Write-Page "initiatives\guriya-magazine\index.html" `
  "Guriya Magazine — Community Publication | Meer Foundation" `
  "Guriya Magazine: Meer Foundation's community publication celebrating women's voices and rural culture in Chhattisgarh." `
  "initiatives/guriya-magazine/" 3 `
  "Guriya Magazine" "Emerging Platform" `
  @"
<section class="section" style="padding-top:140px;background:var(--bg-2);">
...
Write-Page "initiatives\edusuto\index.html" `
  "EduSuTo Courses — Education Sustainability Tourism | Meer Foundation" `
  "EduSuTo — Meer Foundation's curated online learning series covering Education, Sustainability, and Tourism for rural youth and change-makers in Chhattisgarh." `
  "initiatives/edusuto/" 3 `
  "EduSuTo Courses" "Knowledge Platform" `
  @"
<section class="section" style="padding-top:140px;background:var(--bg-2);">
...
Write-Page "initiatives\heritage-walk\index.html" `
  "Social Heritage Walk — Cultural Initiative | Meer Foundation" `
  "Social Heritage Walk: Meer Foundation's immersive community walks celebrating Chhattisgarh's rich cultural heritage and connecting people with their roots." `
  "initiatives/heritage-walk/" 3 `
  "Social Heritage Walk" "Culture" `
  @"
<section class="section" style="padding-top:140px;background:var(--bg-2);">
...
Write-Page "research\index.html" `
  "Research & Publications | Meer Foundation" `
  "Meer Foundation's research portfolio: rivers of Chhattisgarh, IJMEER Journal, academic publications, and CSR research serving ecology and community development." `
  "research/" 2 `
  "Research &amp; Publications" "Knowledge Creation" `
  @"
<section class="section" style="padding-top:140px;background:var(--bg-2);">
  <div class="container">
    <div class="section-header reveal">
...
Write-Page "research\rivers-chhattisgarh\index.html" `
  "Rivers of Chhattisgarh | Meer Foundation Research" `
  "Comprehensive documentation of 20 major rivers of Chhattisgarh — ecology, culture, pollution status, and conservation framework by Meer Foundation." `
  "research/rivers-chhattisgarh/" 3 `
  "Rivers of Chhattisgarh" "Water Research" `
  @"
<section class="section" style="padding-top:140px;background:var(--bg-2);">
...
Write-Page "research\ijmeer\index.html" `
  "IJMEER Journal — International Journal | Meer Foundation" `
  "IJMEER: The International Journal of Multidisciplinary Educational and Ecological Research — an open-access, peer-reviewed quarterly journal published by Meer Foundation." `
  "research/ijmeer/" 3 `
  "IJMEER Journal" "Open-Access Research" `
  @"
<section class="section" style="padding-top:140px;background:var(--bg-2);">
...
Write-Page "research\publications\index.html" `
  "Publications | Meer Foundation Research Output" `
  "Research papers, policy reports, and working documents produced by Meer Foundation covering community development, river conservation, and CSR in Chhattisgarh." `
...
Write-Page "research\csr-research\index.html" `
  "CSR Research | Meer Foundation" `
  "Meer Foundation's CSR research programme: evidence-based corporate social responsibility communication, policy analysis, and implementation frameworks for Chhattisgarh." `
  "research/csr-research/" 3 `
  "CSR Research" "Corporate Social Responsibility" `
  @"
<section class="section" style="padding-top:140px;background:var(--bg-2);">
...
Write-Page "emerging\index.html" `
  "Emerging Platforms | Meer Foundation" `
  "Meer Foundation's emerging media platforms: Community Radio, Media Gallery, News & Press, and Field Notes Blog — amplifying rural voices from Chhattisgarh." `
  "emerging/" 2 `
  "Emerging Platforms" "Media &amp; Communication" `
  @"
<section class="section" style="padding-top:140px;background:var(--bg-2);">
  <div class="container">
    <div class="section-header reveal">
...
Write-Page "emerging\community-radio\index.html" `
  "Community Radio | Meer Foundation" `
  "Meer Foundation's Community Radio initiative bringing local news, health information, and cultural programming to rural communities in regional languages across Chhattisgarh." `
  "emerging/community-radio/" 3 `
  "Community Radio" "Emerging Platform" `
  @"
<section class="section" style="padding-top:140px;background:var(--bg-2);">
...
Write-Page "emerging\media-gallery\index.html" `
  "Media Gallery | Meer Foundation" `
  "Visual documentation of Meer Foundation's community impact — field photography, event coverage, and stories from across Chhattisgarh." `
  "emerging/media-gallery/" 3 `
  "Media Gallery" "Visual Documentation" `
  @"
<section class="section" style="padding-top:140px;background:var(--bg-2);">
...
Write-Page "emerging\news-press\index.html" `
  "News & Press | Meer Foundation" `
  "Meer Foundation in the news — press releases, media coverage, and news stories featuring our community work across Chhattisgarh." `
  "emerging/news-press/" 3 `
...
Write-Page "emerging\field-notes\index.html" `
  "Field Notes Blog | Meer Foundation" `
  "Field Notes — first-hand accounts, reflections, and learnings from Meer Foundation's team members working on the ground across rural Chhattisgarh." `
  "emerging/field-notes/" 3 `
  "Field Notes Blog" "From the Ground" `
  @"
<section class="section" style="padding-top:140px;background:var(--bg-2);">
...
Write-Page "impact\index.html" `
  "Impact | Meer Foundation" `
  "Meer Foundation's community impact across Chhattisgarh — statistics, case studies, district profiles, testimonials and project documentation since 2011." `
  "impact/" 2 `
  "Our Impact" "Measuring Change" `
  @"
<section class="section" style="padding-top:140px;background:var(--bg-2);">
  <div class="container">
    <div class="section-header reveal">
...
Write-Page "impact\statistics\index.html" `
  "Impact Statistics | Meer Foundation" `
  "Meer Foundation impact statistics: 400K+ lives, 10+ districts, 54+ SHGs, 216+ entrepreneurs, 150+ schools across Chhattisgarh since 2011." `
  "impact/statistics/" 3 `
  "Impact Statistics" "Quantified Impact" `
  @"
<section class="section" style="padding-top:140px;background:var(--bg-2);">
...
Write-Page "impact\case-studies\index.html" `
  "Case Studies | Meer Foundation Impact" `
  "Deep-dive case studies of community transformation from Meer Foundation's programmes across Chhattisgarh — river conservation, education, farming, and wellness." `
  "impact/case-studies/" 3 `
  "Case Studies" "Community Transformation" `
  @"
<section class="section" style="padding-top:140px;background:var(--bg-2);">
...
Write-Page "impact\district-profiles\index.html" `
  "District Profiles | Meer Foundation" `
  "Geographic breakdown of Meer Foundation's work across 10+ districts of Chhattisgarh — community context, interventions, and impact data by district." `
  "impact/district-profiles/" 3 `
  "District Profiles" "Geographic Reach" `
  @"
<section class="section" style="padding-top:140px;background:var(--bg-2);">
...
Write-Page "impact\project-gallery\index.html" `
  "Project Gallery | Meer Foundation" `
  "Visual documentation of Meer Foundation's completed and ongoing projects — field photography and project coverage from across Chhattisgarh." `
  "impact/project-gallery/" 3 `
...
Write-Page "impact\testimonials\index.html" `
  "Testimonials | Meer Foundation" `
  "First-hand testimonials from beneficiaries, community leaders, and partner organisations about Meer Foundation's impact in Chhattisgarh." `
  "impact/testimonials/" 3 `
...
Write-Page "get-involved\index.html" `
  "Get Involved | Meer Foundation" `
  "Join Meer Foundation's mission — volunteer, become a CSR partner, apply for an internship, or donate to support community development in Chhattisgarh." `
  "get-involved/" 2 `
...
Write-Page "get-involved\volunteer\index.html" `
  "Volunteer | Meer Foundation" `
  "Volunteer with Meer Foundation — join our grassroots network contributing to water conservation, education, health, and community development across Chhattisgarh." `
  "get-involved/volunteer/" 3 `
  "Volunteer with Us" "Join Our Network" `
  @"
<section class="section" style="padding-top:140px;background:var(--bg-2);">
...
Write-Page "get-involved\csr-partner\index.html" `
  "CSR Partner | Meer Foundation" `
  "Partner with Meer Foundation as your CSR implementing agency. Evidence-based programme design, on-ground execution, and transparent impact reporting in Chhattisgarh." `
  "get-involved/csr-partner/" 3 `
  "Become a CSR Partner" "Corporate Partnership" `
  @"
<section class="section" style="padding-top:140px;background:var(--bg-2);">
...
Write-Page "get-involved\internship\index.html" `
  "Internship | Meer Foundation" `
  "Apply for a Meer Foundation internship — hands-on field experience in social development, research, communications, and community work across Chhattisgarh." `
  "get-involved/internship/" 3 `
  "Internship Programme" "Learn by Doing" `
  @"
<section class="section" style="padding-top:140px;background:var(--bg-2);">
...
Write-Page "get-involved\donate\index.html" `
  "Donate | Support Meer Foundation" `
  "Donate to Meer Foundation — support river conservation, education, and rural empowerment in Chhattisgarh. 80G tax exemption available for Indian donors." `
  "get-involved/donate/" 3 `
  "Support Meer Foundation" "Donate" `
  @"
<section class="section" style="padding-top:140px;background:var(--bg-2);">
...
Write-Page "contact\index.html" `
  "Contact Us | Meer Foundation Chhattisgarh" `
  "Contact Meer Foundation — reach us for partnerships, volunteering, media enquiries, or donations. Based in Dhamtari, Chhattisgarh." `
  "contact/" 2 `
  "Contact Meer Foundation" "Get In Touch" `
  @"
...
Write-Page "legal\privacy-policy\index.html" `
  "Privacy Policy | Meer Foundation" `
  "Meer Foundation's Privacy Policy — how we collect, use, and protect your personal data on meerfoundation.co.in." `
  "legal/privacy-policy/" 3 `
...
Write-Page "legal\terms-of-use\index.html" `
  "Terms of Use | Meer Foundation" `
  "Terms of Use for meerfoundation.co.in — guidelines for using the Meer Foundation website, content, and services." `
  "legal/terms-of-use/" 3 `
  "Terms of Use" "Legal" `
  @"
<section class="section" style="padding-top:140px;background:var(--bg-2);">
...
Write-Page "legal\refund-policy\index.html" `
  "Refund Policy | Meer Foundation" `
  "Meer Foundation refund and cancellation policy for donations and programme fees." `
  "legal/refund-policy/" 3 `
  "Refund Policy" "Legal" `
  @"
<section class="section" style="padding-top:140px;background:var(--bg-2);">
...
Write-Page "legal\disclaimer\index.html" `
  "Disclaimer | Meer Foundation" `
  "Legal disclaimer for meerfoundation.co.in — limitations on information accuracy and liability." `
  "legal/disclaimer/" 3 `
  "Disclaimer" "Legal" `
  @"
<section class="section" style="padding-top:140px;background:var(--bg-2);">
...
Write-Page "legal\cookie-policy\index.html" `
  "Cookie Policy | Meer Foundation" `
  "Meer Foundation cookie policy — how we use cookies and tracking technologies on meerfoundation.co.in." `
...
Write-Page "legal\accessibility\index.html" `
  "Accessibility Statement | Meer Foundation" `
  "Meer Foundation's commitment to web accessibility — our efforts to make meerfoundation.co.in accessible to all users." `
  "legal/accessibility/" 3 `
