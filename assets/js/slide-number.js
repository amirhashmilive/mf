// ============================================================
// DYNAMIC SLIDE NUMBERING & DROPDOWN JUMP SYSTEM
// Presentation Framework — slide-number.js
// ============================================================
...
(function SlideNumberSystem() {
    ...
    function init() {
        ...
        slides.forEach(function (slide, index) {
            ...
            badge.innerHTML = `<span class="sn-badge__label">Slide ${slideNum}</span> <span class="sn-badge__caret">&#9662;</span>`;
